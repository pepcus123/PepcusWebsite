...
*/
      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        cursor.hborder = parseFloat(cursor.outerHeight() - cursor.innerHeight() + self.opt.railpadding['top'] + self.opt.railpadding['bottom']); 
        self.cursor = cursor;        
...
//
    ...
    this.showCursor = function(py,px) {
      ...
      self.cursor.css({height:self.cursorheight,top:self.scroll.y + self.opt.railpadding['top']});
      if (self.cursorh) {
